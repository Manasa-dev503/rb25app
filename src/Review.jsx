...
return (
    <div>
        <center>
            ...
            {
             <div class="card" style={{width:"40%",height:"auto",marginBottom:"30px"}} className="mybox">
                    <center><img src={Reviews[x].image} style={{width:"50%",padding:"5px",height:"50%",borderRadius:"50%"}}/></center>
                    <div class="card-body" style={{width:"auto",padding:"5px"}}>
                        <h1>{Reviews[x].name}</h1>
                        <span class="text-primary">{Reviews[x].job}</span>
                        <p>{Reviews[x].text}</p>
                        <button onClick={()=>{ghi()}}>Previous</button>
                        <button>Surprise Me</button>
                        <button onClick={()=>{def()}}>Next</button>
